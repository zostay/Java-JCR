package Java::JCR::ItemExistsException;
...
study_classes(['javax.jcr.ItemExistsException'], 'Java::JCR');

sub new {
    my $class = shift;

    return bless { 
        obj => Java::JCR::javax::jcr::ItemExistsException->new(@_),
    }, $class;
}
...
Java::JCR::ItemExistsException - Perl wrapper for javax.jcr.ItemExistsException

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.ItemExistsException with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/ItemExistsException.html>
...
The package to use is L<Java::JCR::ItemExistsException>, rather than I<javax.jcr.ItemExistsException>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/ItemExistsException.html>
