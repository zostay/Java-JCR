package Java::JCR::Nodetype::NodeTypeIterator;
...
study_classes(['javax.jcr.nodetype.NodeTypeIterator'], 'Java::JCR');
...
sub next_node_type {
    ...
    my $result = eval { $self->{obj}->nextNodeType(@args) };
    if ($@) { my $e = Java::JCR::Exception->new($@); croak $e }
...
Java::JCR::Nodetype::NodeTypeIterator - Perl wrapper for javax.jcr.nodetype.NodeTypeIterator

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.nodetype.NodeTypeIterator with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/nodetype/NodeTypeIterator.html>
...
The package to use is L<Java::JCR::Nodetype::NodeTypeIterator>, rather than I<javax.jcr.nodetype.NodeTypeIterator>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/nodetype/NodeTypeIterator.html>
