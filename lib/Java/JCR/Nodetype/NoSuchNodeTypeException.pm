package Java::JCR::Nodetype::NoSuchNodeTypeException;
...
study_classes(['javax.jcr.nodetype.NoSuchNodeTypeException'], 'Java::JCR');

sub new {
    my $class = shift;

    return bless { 
        obj => Java::JCR::javax::jcr::nodetype::NoSuchNodeTypeException->new(@_),
    }, $class;
}
...
Java::JCR::Nodetype::NoSuchNodeTypeException - Perl wrapper for javax.jcr.nodetype.NoSuchNodeTypeException

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.nodetype.NoSuchNodeTypeException with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/nodetype/NoSuchNodeTypeException.html>
...
The package to use is L<Java::JCR::Nodetype::NoSuchNodeTypeException>, rather than I<javax.jcr.nodetype.NoSuchNodeTypeException>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/nodetype/NoSuchNodeTypeException.html>
