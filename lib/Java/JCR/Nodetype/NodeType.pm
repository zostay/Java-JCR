...
sub can_add_child_node {
    ...
    my $result = $self->{obj}->canAddChildNode(@args);
    return $result;
}
...
sub get_primary_item_name {
    my $self = shift;
    my @args = Java::JCR::Base::_process_args(@_);
    my $result = $self->{obj}->getPrimaryItemName(@args);
    return $result;
}
...
sub is_mixin {
    my $self = shift;
    my @args = Java::JCR::Base::_process_args(@_);
    my $result = $self->{obj}->isMixin(@args);
    return $result;
}
...
sub can_set_property {
    my $self = shift;
    my @args = Java::JCR::Base::_process_args(@_);
    my $result = $self->{obj}->canSetProperty(@args);
    return $result;
}
...
sub has_orderable_child_nodes {
    my $self = shift;
    my @args = Java::JCR::Base::_process_args(@_);
    my $result = $self->{obj}->hasOrderableChildNodes(@args);
    return $result;
}
...
sub can_remove_item {
    my $self = shift;
    my @args = Java::JCR::Base::_process_args(@_);
    my $result = $self->{obj}->canRemoveItem(@args);
    return $result;
}
