package Java::JCR::Nodetype::ConstraintViolationException;
...
study_classes(['javax.jcr.nodetype.ConstraintViolationException'], 'Java::JCR');

sub new {
    my $class = shift;

    return bless { 
        obj => Java::JCR::javax::jcr::nodetype::ConstraintViolationException->new(@_),
    }, $class;
}
...
Java::JCR::Nodetype::ConstraintViolationException - Perl wrapper for javax.jcr.nodetype.ConstraintViolationException

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.nodetype.ConstraintViolationException with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/nodetype/ConstraintViolationException.html>
...
The package to use is L<Java::JCR::Nodetype::ConstraintViolationException>, rather than I<javax.jcr.nodetype.ConstraintViolationException>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/nodetype/ConstraintViolationException.html>
