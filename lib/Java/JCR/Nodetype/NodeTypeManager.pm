package Java::JCR::Nodetype::NodeTypeManager;
...
study_classes(['javax.jcr.nodetype.NodeTypeManager'], 'Java::JCR');
...
sub get_mixin_node_types {
    ...
    return Java::JCR::Base::_process_return($result, "javax.jcr.nodetype.NodeTypeIterator", "Java::JCR::Nodetype::NodeTypeIterator");
}

sub get_primary_node_types {
    my $self = shift;
    my @args = Java::JCR::Base::_process_args(@_);

    my $result = eval { $self->{obj}->getPrimaryNodeTypes(@args) };
    if ($@) { my $e = Java::JCR::Exception->new($@); croak $e }
...
sub get_node_type {
    ...
    my $result = eval { $self->{obj}->getNodeType(@args) };
    if ($@) { my $e = Java::JCR::Exception->new($@); croak $e }

    return Java::JCR::Base::_process_return($result, "javax.jcr.nodetype.NodeType", "Java::JCR::Nodetype::NodeType");
}

sub get_all_node_types {
    my $self = shift;
    my @args = Java::JCR::Base::_process_args(@_);

    my $result = eval { $self->{obj}->getAllNodeTypes(@args) };
    if ($@) { my $e = Java::JCR::Exception->new($@); croak $e }
...
Java::JCR::Nodetype::NodeTypeManager - Perl wrapper for javax.jcr.nodetype.NodeTypeManager

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.nodetype.NodeTypeManager with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/nodetype/NodeTypeManager.html>
...
The package to use is L<Java::JCR::Nodetype::NodeTypeManager>, rather than I<javax.jcr.nodetype.NodeTypeManager>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/nodetype/NodeTypeManager.html>
