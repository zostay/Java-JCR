package Java::JCR::LoginException;
...
study_classes(['javax.jcr.LoginException'], 'Java::JCR');

sub new {
    my $class = shift;

    return bless { 
        obj => Java::JCR::javax::jcr::LoginException->new(@_),
    }, $class;
}
...
Java::JCR::LoginException - Perl wrapper for javax.jcr.LoginException

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.LoginException with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/LoginException.html>
...
The package to use is L<Java::JCR::LoginException>, rather than I<javax.jcr.LoginException>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/LoginException.html>
