package Java::JCR::ItemNotFoundException;
...
study_classes(['javax.jcr.ItemNotFoundException'], 'Java::JCR');

sub new {
    my $class = shift;

    return bless { 
        obj => Java::JCR::javax::jcr::ItemNotFoundException->new(@_),
    }, $class;
}
...
Java::JCR::ItemNotFoundException - Perl wrapper for javax.jcr.ItemNotFoundException

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.ItemNotFoundException with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/ItemNotFoundException.html>
...
The package to use is L<Java::JCR::ItemNotFoundException>, rather than I<javax.jcr.ItemNotFoundException>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/ItemNotFoundException.html>
