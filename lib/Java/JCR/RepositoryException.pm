package Java::JCR::RepositoryException;
...
study_classes(['javax.jcr.RepositoryException'], 'Java::JCR');

sub new {
    my $class = shift;

    return bless { 
        obj => Java::JCR::javax::jcr::RepositoryException->new(@_),
    }, $class;
}
...
Java::JCR::RepositoryException - Perl wrapper for javax.jcr.RepositoryException

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.RepositoryException with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/RepositoryException.html>
...
The package to use is L<Java::JCR::RepositoryException>, rather than I<javax.jcr.RepositoryException>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/RepositoryException.html>
