package Java::JCR::ValueFormatException;
...
study_classes(['javax.jcr.ValueFormatException'], 'Java::JCR');

sub new {
    my $class = shift;

    return bless { 
        obj => Java::JCR::javax::jcr::ValueFormatException->new(@_),
    }, $class;
}
...
Java::JCR::ValueFormatException - Perl wrapper for javax.jcr.ValueFormatException

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.ValueFormatException with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/ValueFormatException.html>
...
The package to use is L<Java::JCR::ValueFormatException>, rather than I<javax.jcr.ValueFormatException>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/ValueFormatException.html>
