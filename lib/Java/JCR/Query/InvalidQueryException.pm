package Java::JCR::Query::InvalidQueryException;
...
study_classes(['javax.jcr.query.InvalidQueryException'], 'Java::JCR');

sub new {
    my $class = shift;

    return bless { 
        obj => Java::JCR::javax::jcr::query::InvalidQueryException->new(@_),
    }, $class;
}
...
Java::JCR::Query::InvalidQueryException - Perl wrapper for javax.jcr.query.InvalidQueryException

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.query.InvalidQueryException with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/query/InvalidQueryException.html>
...
The package to use is L<Java::JCR::Query::InvalidQueryException>, rather than I<javax.jcr.query.InvalidQueryException>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/query/InvalidQueryException.html>
