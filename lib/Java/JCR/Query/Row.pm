...
study_classes(['javax.jcr.query.Row'], 'Java::JCR');
...
sub get_value {
    ...
    my $result = eval { $self->{obj}->getValue(@args) };
    if ($@) { my $e = Java::JCR::Exception->new($@); croak $e }
...
Java::JCR::Query::Row - Perl wrapper for javax.jcr.query.Row

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.query.Row with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/query/Row.html>
...
The package to use is L<Java::JCR::Query::Row>, rather than I<javax.jcr.query.Row>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/query/Row.html>
