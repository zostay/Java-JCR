...
sub execute {
    ...
    my $result = $self->{obj}->execute(@args);
...
sub get_stored_query_path {
    my $self = shift;
    my @args = Java::JCR::Base::_process_args(@_);
    my $result = $self->{obj}->getStoredQueryPath(@args);
    return $result;
}
...
sub store_as_node {
    my $self = shift;
    my @args = Java::JCR::Base::_process_args(@_);
    my $result = $self->{obj}->storeAsNode(@args);
...
sub get_statement {
    my $self = shift;
    my @args = Java::JCR::Base::_process_args(@_);
    my $result = $self->{obj}->getStatement(@args);
    return $result;
}
...
sub get_language {
    my $self = shift;
    my @args = Java::JCR::Base::_process_args(@_);
    my $result = $self->{obj}->getLanguage(@args);
    return $result;
}
...
For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/query/Query.html>
...
The package to use is L<Java::JCR::Query::Query>, rather than I<javax.jcr.query.Query>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/query/Query.html>
