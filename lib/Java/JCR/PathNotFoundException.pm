package Java::JCR::PathNotFoundException;
...
study_classes(['javax.jcr.PathNotFoundException'], 'Java::JCR');

sub new {
    my $class = shift;

    return bless { 
        obj => Java::JCR::javax::jcr::PathNotFoundException->new(@_),
    }, $class;
}
...
Java::JCR::PathNotFoundException - Perl wrapper for javax.jcr.PathNotFoundException

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.PathNotFoundException with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/PathNotFoundException.html>
...
The package to use is L<Java::JCR::PathNotFoundException>, rather than I<javax.jcr.PathNotFoundException>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/PathNotFoundException.html>
