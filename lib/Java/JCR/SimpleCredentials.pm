package Java::JCR::SimpleCredentials;
...
study_classes(['javax.jcr.SimpleCredentials'], 'Java::JCR');
...
sub set_attribute {
    ...
    my $result = eval { $self->{obj}->setAttribute(@args) };
...
sub get_password {
    ...
    my $result = eval { $self->{obj}->getPassword(@args) };
    if ($@) { my $e = Java::JCR::Exception->new($@); croak $e }
...
sub remove_attribute {
    ...
    my $result = eval { $self->{obj}->removeAttribute(@args) };
    if ($@) { my $e = Java::JCR::Exception->new($@); croak $e }
...
Java::JCR::SimpleCredentials - Perl wrapper for javax.jcr.SimpleCredentials

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.SimpleCredentials with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/SimpleCredentials.html>
...
The package to use is L<Java::JCR::SimpleCredentials>, rather than I<javax.jcr.SimpleCredentials>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/SimpleCredentials.html>
