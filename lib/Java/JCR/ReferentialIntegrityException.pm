package Java::JCR::ReferentialIntegrityException;
...
study_classes(['javax.jcr.ReferentialIntegrityException'], 'Java::JCR');

sub new {
    my $class = shift;

    return bless { 
        obj => Java::JCR::javax::jcr::ReferentialIntegrityException->new(@_),
    }, $class;
}
...
Java::JCR::ReferentialIntegrityException - Perl wrapper for javax.jcr.ReferentialIntegrityException

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.ReferentialIntegrityException with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/ReferentialIntegrityException.html>
...
The package to use is L<Java::JCR::ReferentialIntegrityException>, rather than I<javax.jcr.ReferentialIntegrityException>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/ReferentialIntegrityException.html>
