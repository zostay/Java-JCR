package Java::JCR::AccessDeniedException;
...
study_classes(['javax.jcr.AccessDeniedException'], 'Java::JCR');

sub new {
    my $class = shift;

    return bless { 
        obj => Java::JCR::javax::jcr::AccessDeniedException->new(@_),
    }, $class;
}
...
Java::JCR::AccessDeniedException - Perl wrapper for javax.jcr.AccessDeniedException

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.AccessDeniedException with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/AccessDeniedException.html>
...
The package to use is L<Java::JCR::AccessDeniedException>, rather than I<javax.jcr.AccessDeniedException>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/AccessDeniedException.html>
