...
sub has_version_label {
    ...
    my $result = eval { $self->{obj}->hasVersionLabel(@args) };
    if ($@) { my $e = Java::JCR::Exception->new($@); croak $e }
...
sub get_root_version {
    ...
    my $result = eval { $self->{obj}->getRootVersion(@args) };
    if ($@) { my $e = Java::JCR::Exception->new($@); croak $e }
...
sub remove_version_label {
    ...
    my $result = eval { $self->{obj}->removeVersionLabel(@args) };
    if ($@) { my $e = Java::JCR::Exception->new($@); croak $e }
...
sub remove_version {
    ...
    my $result = eval { $self->{obj}->removeVersion(@args) };
    if ($@) { my $e = Java::JCR::Exception->new($@); croak $e }
...
sub get_all_versions {
    ...
    my $result = eval { $self->{obj}->getAllVersions(@args) };
    if ($@) { my $e = Java::JCR::Exception->new($@); croak $e }
...
sub get_version_labels {
    ...
    my $result = eval { $self->{obj}->getVersionLabels(@args) };
    if ($@) { my $e = Java::JCR::Exception->new($@); croak $e }
...
sub add_version_label {
    ...
    my $result = eval { $self->{obj}->addVersionLabel(@args) };
    if ($@) { my $e = Java::JCR::Exception->new($@); croak $e }
...
sub get_version {
    ...
    my $result = eval { $self->{obj}->getVersion(@args) };
    if ($@) { my $e = Java::JCR::Exception->new($@); croak $e }
...
sub get_versionable_uuid {
    ...
    my $result = eval { $self->{obj}->getVersionableUUID(@args) };
    if ($@) { my $e = Java::JCR::Exception->new($@); croak $e }
