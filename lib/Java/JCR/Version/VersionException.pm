package Java::JCR::Version::VersionException;
...
study_classes(['javax.jcr.version.VersionException'], 'Java::JCR');

sub new {
    my $class = shift;

    return bless { 
        obj => Java::JCR::javax::jcr::version::VersionException->new(@_),
    }, $class;
}
...
Java::JCR::Version::VersionException - Perl wrapper for javax.jcr.version.VersionException

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.version.VersionException with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/version/VersionException.html>
...
The package to use is L<Java::JCR::Version::VersionException>, rather than I<javax.jcr.version.VersionException>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/version/VersionException.html>
