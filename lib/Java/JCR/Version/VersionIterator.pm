package Java::JCR::Version::VersionIterator;
...
study_classes(['javax.jcr.version.VersionIterator'], 'Java::JCR');
...
sub next_version {
    ...
    my $result = eval { $self->{obj}->nextVersion(@args) };
    if ($@) { my $e = Java::JCR::Exception->new($@); croak $e }
...
Java::JCR::Version::VersionIterator - Perl wrapper for javax.jcr.version.VersionIterator

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.version.VersionIterator with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/version/VersionIterator.html>
...
The package to use is L<Java::JCR::Version::VersionIterator>, rather than I<javax.jcr.version.VersionIterator>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/version/VersionIterator.html>
