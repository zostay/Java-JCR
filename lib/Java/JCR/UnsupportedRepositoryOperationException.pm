package Java::JCR::UnsupportedRepositoryOperationException;
...
study_classes(['javax.jcr.UnsupportedRepositoryOperationException'], 'Java::JCR');

sub new {
    my $class = shift;

    return bless { 
        obj => Java::JCR::javax::jcr::UnsupportedRepositoryOperationException->new(@_),
    }, $class;
}
...
Java::JCR::UnsupportedRepositoryOperationException - Perl wrapper for javax.jcr.UnsupportedRepositoryOperationException

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.UnsupportedRepositoryOperationException with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/UnsupportedRepositoryOperationException.html>
...
The package to use is L<Java::JCR::UnsupportedRepositoryOperationException>, rather than I<javax.jcr.UnsupportedRepositoryOperationException>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/UnsupportedRepositoryOperationException.html>
