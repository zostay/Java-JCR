package Java::JCR::InvalidSerializedDataException;
...
study_classes(['javax.jcr.InvalidSerializedDataException'], 'Java::JCR');

sub new {
    my $class = shift;

    return bless { 
        obj => Java::JCR::javax::jcr::InvalidSerializedDataException->new(@_),
    }, $class;
}
...
Java::JCR::InvalidSerializedDataException - Perl wrapper for javax.jcr.InvalidSerializedDataException

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.InvalidSerializedDataException with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/InvalidSerializedDataException.html>
...
The package to use is L<Java::JCR::InvalidSerializedDataException>, rather than I<javax.jcr.InvalidSerializedDataException>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/InvalidSerializedDataException.html>
