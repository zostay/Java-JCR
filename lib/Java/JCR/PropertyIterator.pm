package Java::JCR::PropertyIterator;
...
study_classes(['javax.jcr.PropertyIterator'], 'Java::JCR');
...
sub next_property {
    ...
    my $result = eval { $self->{obj}->nextProperty(@args) };
    if ($@) { my $e = Java::JCR::Exception->new($@); croak $e }
...
Java::JCR::PropertyIterator - Perl wrapper for javax.jcr.PropertyIterator

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.PropertyIterator with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/PropertyIterator.html>
...
The package to use is L<Java::JCR::PropertyIterator>, rather than I<javax.jcr.PropertyIterator>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/PropertyIterator.html>
