package Java::JCR::InvalidItemStateException;
...
study_classes(['javax.jcr.InvalidItemStateException'], 'Java::JCR');

sub new {
    my $class = shift;

    return bless { 
        obj => Java::JCR::javax::jcr::InvalidItemStateException->new(@_),
    }, $class;
}
...
Java::JCR::InvalidItemStateException - Perl wrapper for javax.jcr.InvalidItemStateException

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.InvalidItemStateException with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/InvalidItemStateException.html>
...
The package to use is L<Java::JCR::InvalidItemStateException>, rather than I<javax.jcr.InvalidItemStateException>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/InvalidItemStateException.html>
