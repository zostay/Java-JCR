package Java::JCR::NamespaceException;
...
study_classes(['javax.jcr.NamespaceException'], 'Java::JCR');

sub new {
    my $class = shift;

    return bless { 
        obj => Java::JCR::javax::jcr::NamespaceException->new(@_),
    }, $class;
}
...
Java::JCR::NamespaceException - Perl wrapper for javax.jcr.NamespaceException

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.NamespaceException with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/NamespaceException.html>
...
The package to use is L<Java::JCR::NamespaceException>, rather than I<javax.jcr.NamespaceException>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/NamespaceException.html>
