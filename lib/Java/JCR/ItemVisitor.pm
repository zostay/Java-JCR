...
study_classes(['javax.jcr.ItemVisitor'], 'Java::JCR');
...
Java::JCR::ItemVisitor - Perl wrapper for javax.jcr.ItemVisitor

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.ItemVisitor with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/ItemVisitor.html>
...
The package to use is L<Java::JCR::ItemVisitor>, rather than I<javax.jcr.ItemVisitor>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/ItemVisitor.html>
