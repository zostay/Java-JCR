package Java::JCR::Lock::LockException;
...
study_classes(['javax.jcr.lock.LockException'], 'Java::JCR');

sub new {
    my $class = shift;

    return bless { 
        obj => Java::JCR::javax::jcr::lock::LockException->new(@_),
    }, $class;
}
...
Java::JCR::Lock::LockException - Perl wrapper for javax.jcr.lock.LockException

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.lock.LockException with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/lock/LockException.html>
...
The package to use is L<Java::JCR::Lock::LockException>, rather than I<javax.jcr.lock.LockException>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/lock/LockException.html>
