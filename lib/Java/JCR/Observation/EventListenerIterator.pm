package Java::JCR::Observation::EventListenerIterator;
...
study_classes(['javax.jcr.observation.EventListenerIterator'], 'Java::JCR');
...
sub next_event_listener {
    my $self = shift;
    my @args = Java::JCR::Base::_process_args(@_);

    my $result = eval { $self->{obj}->nextEventListener(@args) };
    if ($@) { my $e = Java::JCR::Exception->new($@); croak $e }

    return Java::JCR::Base::_process_return($result, "javax.jcr.observation.EventListener", "Java::JCR::Observation::EventListener");
}
...
Java::JCR::Observation::EventListenerIterator - Perl wrapper for javax.jcr.observation.EventListenerIterator

=head1 DESCRIPTION

This is an automatically generated package wrapping javax.jcr.observation.EventListenerIterator with a nice Perlish API.

For full documentation of what this class does, see the Java API documentation: L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/observation/EventListenerIterator.html>
...
The package to use is L<Java::JCR::Observation::EventListenerIterator>, rather than I<javax.jcr.observation.EventListenerIterator>.
...
L<Java::JCR>, L<http://www.day.com/maven/jsr170/javadocs/jcr-1.0/javax/jcr/observation/EventListenerIterator.html>
